...
var getUser = function (request, h) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, userCollection.findOne({ _id: id })];
            case 2:
                user = _a.sent();
                return [2 /*return*/, h.response({ success: true, data: user }).code(200)];
            case 3:
                error_1 = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                return [2 /*return*/, h.response({ success: false, error: error_3.message }).code(500)];
            case 4: return [2 /*return*/];
        }
    });
}); };
